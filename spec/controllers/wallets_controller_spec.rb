...
RSpec.describe WalletsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested wallet as @wallet" do
      wallet = Wallet.create! valid_attributes
      get :show, params: {id: wallet.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested wallet as @wallet" do
      wallet = Wallet.create! valid_attributes
      get :edit, params: {id: wallet.to_param}, session: valid_session
      expect(assigns(:wallet)).to eq(wallet)
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved wallet as @wallet" do
        post :create, params: {wallet: invalid_attributes}, session: valid_session
        expect(assigns(:wallet)).to be_a_new(Wallet)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested wallet" do
        wallet = Wallet.create! valid_attributes
        put :update, params: {id: wallet.to_param, wallet: new_attributes}, session: valid_session
        wallet.reload
      ...
      it "assigns the requested wallet as @wallet" do
        wallet = Wallet.create! valid_attributes
        put :update, params: {id: wallet.to_param, wallet: valid_attributes}, session: valid_session
        expect(assigns(:wallet)).to eq(wallet)
      end
    ...
    context "with invalid params" do
      it "assigns the wallet as @wallet" do
        wallet = Wallet.create! valid_attributes
        put :update, params: {id: wallet.to_param, wallet: invalid_attributes}, session: valid_session
        expect(assigns(:wallet)).to eq(wallet)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested wallet" do
      wallet = Wallet.create! valid_attributes
      expect {
        delete :destroy, params: {id: wallet.to_param}, session: valid_session
      }.to change(Wallet, :count).by(-1)
    end
